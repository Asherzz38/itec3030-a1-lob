...
public class Exchange {
	...
	public void submitOrder(IOrder o, long time) {
		...
		for (ITrade t:oOutcome.getResultingTrades()) {
			...
			accounts.getTraderAccount(t.getBuyer()).withdrawMoney(account.getFee(t) * t.getQuantity());
			...
			accounts.getTraderAccount(t.getSeller()).addMoney(account.getFee(t) * t.getQuantity());
